...
// write a test program to count the numbers of check boxes on the page checked and unchecked ones.
...
try {
    ...
    $host = 'http://localhost:50575'; // Selenium server address
    ...
    $driver->get('C:\zyan\Checkbox9.html'); // Replace with actual file path or URL
