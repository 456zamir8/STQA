...
// write and test a program to select the number of students who have scored more than 60 in any subject(or all subjects)
...
$serverUrl = 'http://127.0.0.1:50575';
...
$driver->get('C:\zyan\marksheet.html');  // replace with your file URL or path
